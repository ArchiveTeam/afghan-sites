...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--warc-header', 'afghan-sites-dld-script-version: ' + VERSION,
            '--warc-header', ItemInterpolation('afghan-sites-item: %(item_name)s'),
...
project = Project(
    title = 'Afghan sites',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://wiki.archiveteam.org/images/2/2a/AFG-NIC-logo.png" height="50px"/>
    <h2>Afghan sites <span class="links"><a href="https://archiveteam.org/">Website</a> &middot; <a href="http://tracker.archiveteam.org/afghan-sites/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='afghan-sites'),
    WgetDownload(
        WgetArgs(),
        max_tries=1,
